...
const MatchesSection = () => {
  ...
  const logoFuria = "/logos/Furia_Esports_logo.png";
  ...
  return <div className="space-y-6">
      ...
      {activeTab === 'upcoming' && <div className="space-y-4">
          ...
          className={`bg-[${background}]  rounded-lg p-4 border border-[${stroke}] transition-colors`}>
              <div className="flex justify-between items-center placc">
                <div>
              ...
              <div className="mt-4 flex justify-between justify-items">
                ...
                <div className={`text-lg font-bold text-[${stroke}] self-center justify-between`}>VS</div>
                <div className="flex items-center">
      ...
      {activeTab === 'recent' && <div className="space-y-4">
          ...
          className={`bg-[${background}] rounded-lg p-4 border border-[${stroke}]`}> {/* ${match.result === 'Won' ? 'border-green-600' : 'border-red-600'}  */} 
              ...
              <div className="mt-4 flex justify-between justify-items-center">
                <div className="flex items-center">
                  <img src={logoFuria} 
                  alt="FURIA Logo" className="h-12 w-12 mr-2" />
                  {/* <span className="font-bold">FURIA</span> */}
                </div>
                ...
                <div className="flex items-center self-end ml-2">
                  {/* <span className="font-bold mr-2">{match.opponent}</span> */}
                  <img src={match.oponnent_logo} 
                  alt={`${match.opponent} Logo`} 
